...
public:
	...
	addr_t doubleFilter_start_addr = 0x73000000;
 	addr_t doubleFilter_size = 0x01000000;
 	addr_t doubleFilter_end_addr = doubleFilter_start_addr + doubleFilter_size - 1;
	...
	void parse(int argc, char **argv) override {
		...
		assert((mem_end_addr < clint_start_addr || mem_start_addr > doubleFilter_end_addr) &&
...
int sc_main(int argc, char **argv) {
	...
	bus.ports[12] = new PortMapping(opt.doubleFilter_start_addr, opt.doubleFilter_end_addr);
	...
	bus.isocks[12].bind(double_filter.tsock);
